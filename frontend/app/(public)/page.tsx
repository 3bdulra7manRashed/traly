    ...
    <div className="relative min-h-screen bg-[#070B11] text-slate-100 overflow-hidden flex flex-col gap-24 pb-24">
      ...
      <section className="relative pt-16 pb-20 overflow-hidden z-10">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center">
          {/* Subtle Dignified Pre-title Badge (max-w-fit) */}
          <div className="inline-flex max-w-fit items-center gap-2.5 rounded-full border border-emerald-500/30 bg-[#0B1118]/80 px-4 py-1.5 text-xs font-semibold text-emerald-300 shadow-md shadow-emerald-950/40 backdrop-blur-xl mb-6">
          ...
          {/* Main Headline (Bold, High-Contrast, max-w-3xl) */}
          <h1 className="max-w-3xl text-3xl sm:text-5xl md:text-6xl font-extrabold text-white tracking-tight leading-[1.2] mb-6">
            أدوات ذكية تصنع{" "}
          ...
          {/* Subtitle (max-w-3xl) */}
          <p className="max-w-3xl text-sm sm:text-lg md:text-xl text-slate-300 leading-relaxed mb-10 font-normal">
          ...
          {/* LLM Prompt-Search Launchpad with Suggestions Starters (w-full max-w-4xl) */}
